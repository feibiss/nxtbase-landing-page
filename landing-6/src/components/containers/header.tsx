...
export default function Header() {
  ...
  return (
    <header className="sticky left-0 top-0 z-50 flex h-[--navbar-height] items-centermd:px-8 px-4 bg-white dark:border-gray-700 my-3 pb-2">
      ...
      <div className="ml-auto flex items-center justify-end mt-3">
        <Button
          ...
          size={"sm"}
          rounded={"full"}
          className="hidden px-8 py-1 md:block  bg-primary text-sm font-medium leading-5 text-white"
        >
