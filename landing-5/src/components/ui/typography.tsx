...
const typographyVariants = cva("text-black dark:text-white w-fit h-fit", {
  variants: {
    variant: {
      h1: " text-3xl font-semibold md:leading-tight max-w-xs sm:max-w-2xl md:text-5xl",
      h2: " font-semibold first:mt-0 text-center text-3xl md:text-4xl lg:text-4xl",
      ...
      p: "leading-10 text-lg [&:not(:first-child)]:mt-6",
