...
export default function Header() {
  return (
    <header className="absolute top-0 max-w-screen  inset-x-0 z-50 flex h-[--navbar-height] py-4 w-full items-center justify-evenly lg:px-8 px-8 text-white backdrop-blur-md mx-auto">
