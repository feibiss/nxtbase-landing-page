...
export default function FeatureCard({ feature }: { feature: FeatureType }) {
  return (
    <div className=" group relative row-span-1 mx-auto w-full rounded-md">
      <Card className="relative  z-10 w-full border-none bg-transparent shadow-none ">
        ...
        >
          ...
          <div className="order-0 col-span-1 flex h-full w-full items-center justify-center">
            <video
              autoPlay
              loop
              muted
...
export const FeatureCardV2 = ({ feature }: { feature: FeatureType }) => {
  return (
    <div className="px-8 md:px-16 lg:px-32 overflow-hidden bg-white py-24 sm:py-32">
