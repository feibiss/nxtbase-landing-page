...
const typographyVariants = cva("text-foreground w-fit h-fit", {
  variants: {
    variant: {
      h1: " text-4xl md:text-5xl font-bold tracking-tighter lg:text-6xl/[1.375]",
      h2: " font-bold first:mt-0 text-center text-2xl/8 md:text-4xl/6 lg:text-5xl/[1.375]",
      ...
      subheading: "text-base/6 font-light  md:text-xl/7 lg:text-xl/8",
    },
  },
  defaultVariants: {
    variant: "p",
