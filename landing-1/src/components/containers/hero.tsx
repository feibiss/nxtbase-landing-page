...
export default function Hero() {
  ...
  return (
    <Container>
      <div className="text-center col-span-12 h-full lg:h-[calc(100dvh-var(--navbar-height))] md:h-[calc(100dvh-var(--navbar-height)*2.5)] gap-1 snap-start scroll-mt-[6rem] flex flex-col items-center justify-center my-8 md:my-6">
