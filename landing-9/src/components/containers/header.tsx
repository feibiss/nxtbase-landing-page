...
export default function Header() {
  return (
    <header className="fixed bottom-16 bg-gray-950 dark:bg-stone-900  -translate-x-1/2 left-1/2 text-white w-[95dvw] md:w-fit rounded-full z-[60] shadow-lg flex items-center justify-evenly">
      <div className="  w-full flex text-xs lg:text-base justify-between items-center">
        <button
          className="p-0 flex justify-center items-center size-14 min-h-14 h-full bg-gray-700 rounded-full hover:bg-emerald-700"
          onClick={() =>
            window.scroll({
              top: 0,
              behavior: "smooth",
