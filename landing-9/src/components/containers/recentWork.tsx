...
const RecentWork = () => {
  return (
    <Container id="recent_work" className="md:py-20 mb-12 mt-8">
      <div className="px-4 md:px-40">
        <Typography
          variant="h3"
          className="w-full flex items-center justify-start text-start pb-2 text-yellow-900"
        >
          Recent Work
        </Typography>
        <Typography
      ...
      <div className="grid grid-cols-1 gap-8 px-4 md:px-40">
        {/* First row */}
